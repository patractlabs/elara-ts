...
export default class Response {
    ...
    static async Ok(res: Http.ServerResponse, data: any, stat: Statistics): PVoidT {
        stat.code = 200
    ...
    static async Fail(res: Http.ServerResponse, data: any, code: number, stat: Statistics): PVoidT {
        log.debug('response statistics result: ', stat)
        stat.code = code
        stat.delay = Util.traceDelay(stat.start)
